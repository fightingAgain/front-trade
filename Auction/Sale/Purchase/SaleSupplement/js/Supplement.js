...
var view='Auction/Sale/Purchase/SaleSupplement/model/view_model.html';
function initTable() {
		...
		,{
			...
			formatter:function(value, row, index){	
				...
				var State='<div class="btn-group" style="padding-left: 10px;">'
						+'<button class="btn-xs btn btn-primary" href="#" style="text-decoration:none" onclick=showProjectSupplementInfo(\"'+row.id+'\",\"'+(row.enterpriseId || "")+'\",\"'+(row.pEnterpriseId||"")+'\",\"'+row.createType+'\")>'
