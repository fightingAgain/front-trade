...
//	$("#projectCode").html(rowData.projectCode);
	...
	// if(checkType == 'check'){//查看
		...
		getFileList();//文件递交记录
	// };
	warnLists(projectId, 'jm', false, false, true,projectId,'2','1');
...
function fileHandTable(data) {
	...
	html += '<tr><th style="width:50px;text-align: center;">序号</th><th style="width:150px;">供应商名称</th><th style="width:100px;text-align: center;">社会信用代码</th><th style="width:200px;">竞卖文件名称</th><th style="width:150px;text-align: center;">递交/撤回时间</th><th style="width:100px;text-align: center;">操作类型</th></tr>'
