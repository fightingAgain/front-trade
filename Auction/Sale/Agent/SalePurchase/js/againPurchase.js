...
/// 表格初始化
var purchaseaddurl = 'Auction/Sale/Agent/SalePurchase/model/againPurchaseAddModel.html'
var auditPurchase = 'Auction/Sale/Agent/SalePurchase/model/auditPurchase.html' //查看路径
var editPurchase = 'Auction/Sale/Agent/SalePurchase/model/edit_model.html' //编辑路径
//var auditPurchase = 'Auction/Sale/Agent/SalePurchase/model/CXJMauditPurchase.html' //查看路径
//var editPurchase = 'Auction/Sale/Agent/SalePurchase/model/CXJMedit_model.html' //编辑路径
...
function edit_btn($index, projectState) {
	...
	if(groupCodedata == null || groupCodedata == '' || groupCodedata ==undefined) {
		var editPurchase = 'Auction/Sale/Agent/SalePurchase/model/edit_model.html'
	} else if((groupCodedata != null || groupCodedata != '' || groupCodedata !=undefined)&&  groupCodedata =='00270012'){
		var editPurchase = 'Auction/Sale/Agent/SalePurchase/model/CXJMedit_model.html'
	}
	parent.layer.open({
		type: 2, //此处以iframe举例
		title: '编辑公告',
