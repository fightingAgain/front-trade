...
function du(isPublic,projectIds,purchaserId,classificaCode,type){	
	...
	if(isPublic==3){
		...
		supplierListUrl=config.AuctionHost+'/EnterpriseController/page.do'
	}
...
$("#eventquery").click(function() {
	...
	du(isPublics,projectId,purchaserIds,classificaCodes,types)
});
function initTable() {
...
$("#evenTrue").on('click',function(){
   ...
   var para={
    ...
    $.ajax({
    	type:"post",
    	url:top.config.AuctionHost+"/ProjectSupplierController/saveAppendProjectSupplier.do",
    	async:true,
    	data:para,
