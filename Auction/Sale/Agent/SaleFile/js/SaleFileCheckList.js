...
function AuctionFileCheck(data, type, createType) {
	...
	if(rowData.groupCode=='00270012' && rowData.groupCode !=undefined){
			var contenturl='Auction/Sale/Agent/SaleFile/modal/JMSaleFileCheckInfo.html?createType='+createType+'&projectId='+data
	}else{
			var contenturl='Auction/Sale/Agent/SaleFile/modal/SaleFileCheckInfo.html?createType='+createType+'&projectId='+data
	}
