...
function getMsg(datall,type,callback){
	...
	modelOption({'tempType':'auctionResultsNotification','projectType':datall.projectType,'isWin':datall.isBid==1?0:1});	
	...
	$("#btnModel").on('click',function(){
		...
		parent.layer.confirm('温馨提示：是否确认切换模板', {
			...
			modelHtml({'type':'jgtzs', 'projectId':datall.projectId,'packageId':datall.packageId,'tempId':templateId,'tenderType':2,'supplierId':datall.supplierId,"bidPrice":datall.bidPrice || ''})
