...
function AddFunction(value, row, index) { //把需要创建的按钮封装到函数中
	...
	return [
		'<a href="javascript:void(0)" id="btnShow" class="btn-sm btn-primary" style="text-decoration:none" ><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>查 看</a>&nbsp;&nbsp;',
	].join("")
...
$(function() {
	...
	$("#btnSearch").on('click', function() {
		$('#BidResultList').bootstrapTable('refresh');
	});
