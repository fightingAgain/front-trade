...
/// 表格初始化
var auditPurchase='Auction/Sale/Supplier/SupplierSalePurchase/model/SalePurchaseInfo.html'//审核路径
function initTable() {
...
function audit_btn($index){   
	...
	if(groupCodedata == null || groupCodedata == '' || groupCodedata ==undefined) {
		...
		var auditPurchase='Auction/Sale/Supplier/SupplierSalePurchase/model/JMSalePurchaseInfo.html'//审核路径
	}
    parent.layer.open({
        type: 2 //此处以iframe举例
        ,title: '查看竞卖'
