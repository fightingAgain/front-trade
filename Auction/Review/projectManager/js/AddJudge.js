...
//	var Id1=sysEnterpriseId.indexOf('6a21e3d8d37b48b9b039298c65e47ef7')
	/* if(sysEnterpriseId.indexOf(enterpriseId)>-1){
		if(isAgent){
			if(isAgent==0){
		   var viewhtml='view/projectType/projectType.html?type=1&select=1&interpriceType=1'
		}else if(isAgent==1){
		  var viewhtml='view/projectType/projectType.html?type=1&select=1&interpriceType=2'
		}
		}else{
			var viewhtml='view/projectType/projectType.html?type=1&select=1&interpriceType=1'
		}
