 ...
 * @LastEditTime: 2020-10-29 18:21:34
...
//				return html.join("");   
	...
	for(var i = 0; i < quotationData.length; i++){
		...
		if(isOfferDetailedItem == 0 &&quotationData[i].fileName && quotationData[i].filePath){
