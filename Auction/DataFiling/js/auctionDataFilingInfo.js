...
var resData;
$(function() {
	if(getUrlParam('WORKFLOWTYPE')){
		WORKFLOWTYPE = getUrlParam('WORKFLOWTYPE')
	}
	/* 退回申请 */
	if(uid&&WORKFLOWTYPE!='zlgd'){
		$('.show_fallback').show();
	...
	$("#downLoadAll").on('click', function() {
		var newUrl = alldownUrl + "?packageId=" + packageId + '&tenderType=1';
