				...
				switch(packageData.auctionModel) {
					case 0: //按包件
						$('.leftTab').append([
							...
							'<tr><td colspan="2" style="font-size: 20px !important;font-weight: bold;">当前最低报价(元):<span class="minPrice"></span></td></tr>',
...
//						},
						...
						if(packageData.outType == 1 && (curStage == 4 || curStage == 6)) {
							column_left.push({
								title: '操作',
								formatter: function(value, row, index) {
...
function jumpToHistory() {
	...
	location.href = $.parserUrlForToken("OfferHistoryInfo.html?projectId=" + projectId + "&packageId=" + packageId + "&tType=" + "1");
}