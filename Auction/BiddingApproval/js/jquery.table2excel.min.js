            ...
            $(e.element).each( function(i,o) {
                ...
                $(o).find("tr").not(e.settings.exclude).each(function (i,p) {
                    ...
                    $(p).find("td,th").not(e.settings.exclude).each(function (i,q) { // p did not exist, I corrected
                        ...
                        if( rc.flag.length > 0 ) {
                            tempRows += "<td style=\"height:30px; font-size:16px;\"align='center' valign='center'> </td>"; // exclude it!!
                        } else {

                            let obj = $(q);
                            let type= obj.data('set');
                            let res = $(q).html();
                            if(type=='price'){

                                tempRows += "<td style=\"mso-number-format:'0.00'; height:30px; font-size:16px;\" align='center' valign='center'";
                                if( rc.rows > 0) {
                                ...
                                res = '<font color="red">'+Number(obj.text()).toFixed(2)+'</font>';
                            }else{

                                tempRows += "<td style=\"height:30px; font-size:16px;\" align='center' valign='center'";
                                if( rc.rows > 0) {
                                    tempRows += " rowspan='" + rc.rows + "' ";
                                }
                                if( rc.cols > 0) {
