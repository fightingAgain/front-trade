...
window.openAudit = {
	"click .detailed": function(e, value, row, index) {
		if(row.groupCode!=""&&row.groupCode=='00270012'){
			if(row.accepType=='fjwz_jmhq'){
				var lookContentUrl = "Auction/commondingApproval/model/JMlookBidStateApproval.html";
			}
//			else{
...
//	    }
	...
	"click .audit": function(e, value, row, index) {
     if(row.groupCode!=""&&row.groupCode=='00270012'){
		 if(row.accepType=='fjwz_jmhq'){
			 var contentUrl = "Auction/commondingApproval/model/JMcheckBidStateApproval.html";
		 }
//		 else{
