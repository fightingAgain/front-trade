		...
		switch(row.tenderType) {			
			...
			case 2: //竞卖
				top.layer.open({
					...
					resize: false,
					title: "查看",
					content: 'bidPrice/ProjectCheck/modal/SupplementAuctionCheckListInfo.html?key=' + row.id + '&edittype=detailed&tenderType=' + row.tenderType,
				});
				break;
		}
	},
		...
		switch(row.tenderType) {
			...
			case 2: //竞卖				
				top.layer.open({
					...
					resize: false,
					title: "审核",
					content: 'bidPrice/ProjectCheck/modal/SupplementAuctionCheckListInfo.html?key=' + row.id + '&edittype=audit&tenderType=' + row.tenderType+'&timeOut='+row.isTimeOut,
				});
				break;
		}
	}
