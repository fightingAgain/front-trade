...
window.bidNoticeAudit = {
	"click .detailed": function(e, value, row, index) { //查看
		...
		switch(row.tenderType) {
			case 0: //询价
			case 6: //单一来源采购
				content = 'bidPrice/ProjectCheck/modal/BidNoticeCheckListInfo.html?key=' + row.id + '&edittype=detailed';
				break;
			case 1: //竞价
				content = 'bidPrice/ProjectCheck/modal/AuctionNoticeCheckListInfo.html?key=' + row.id + '&edittype=detailed';
				break;
			case 2: //竞卖
				content = 'bidPrice/ProjectCheck/modal/SaleNoticeCheckListInfo.html?key=' + row.id + '&edittype=detailed';
				break;
			case 12: //单一来源采购
				content = 'bidPrice/ProjectCheck/modal/JtBidNoticeCheckListInfo.html?key=' + row.id + '&edittype=detailed';
				break;
			case 13: //单一来源采购
				content = 'bidPrice/ProjectCheck/modal/JcBidNoticeCheckListInfo.html?key=' + row.id + '&edittype=detailed';
				break;	
		}
		top.layer.open({
			type: 2,
	...
	"click .audit": function(e, value, row, index) {
		...
		switch(row.tenderType) {
			case 0: //询价
			case 6: //单一来源采购
				content = 'bidPrice/ProjectCheck/modal/BidNoticeCheckListInfo.html?key=' + row.id + '&edittype=audit';
				break;
			case 1: //竞价
				content = 'bidPrice/ProjectCheck/modal/AuctionNoticeCheckListInfo.html?key=' + row.id + '&edittype=audit';
				break;
			case 2: //竞卖
				content = 'bidPrice/ProjectCheck/modal/SaleNoticeCheckListInfo.html?key=' + row.id + '&edittype=audit';
				break;
			case 12: //单一来源采购
				content = 'bidPrice/ProjectCheck/modal/JtBidNoticeCheckListInfo.html?key=' + row.id + '&edittype=audit';
				break;
			case 13: //单一来源采购
				content = 'bidPrice/ProjectCheck/modal/JcBidNoticeCheckListInfo.html?key=' + row.id + '&edittype=audit';
				break;
		}
