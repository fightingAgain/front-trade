var uid="";
var gid=""
var projecturl='Auction/Auction/Agent/AuctionPurchase/model/againAddProject.html';
...
function passMessage(callback){
	...
	$('#btn_submit').click(function(){
		...
		bidSectionIds = [];
		for(var i=0;i<allSelect.length;i++){
			bidSectionIds.push(allSelect[i].id);
		}
		
		var msg = checkStatisticalReport(bidSectionIds, 1)
		if(msg != ''){
			top.layer.alert(msg);
			return
		}
