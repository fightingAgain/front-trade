...
var pushHtml = 'Auction/Auction/Agent/AuctionNotice/modal/pushInfo.html'; //数据推送
...
function checkDetail(packageId, type,index) {
	...
	top.layer.open({
		...
		resize: false,
		closeBtn: 1,
		content: 'Auction/Auction/Agent/AuctionNotice/modal/AuctionResultInfo.html?special=' + type + '&keyId=' + rows.id+ '&id=' + rows.packageId+ '&projectId=' + rows.projectId,
	});
}
