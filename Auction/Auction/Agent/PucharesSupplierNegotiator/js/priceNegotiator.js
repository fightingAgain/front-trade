...
function negotiatorTableShow(){
	...
	var nes = {
		'projectId': projectId,
		'packageId':packageId,'tenderType':tenderTypeCode,
	}
...
function showData(i){
	...
	parent.layer.open({
        ...
        ,content:'Auction/Auction/Agent/PucharesSupplierNegotiator/showNegotiator.html'
...
$("#btnAdd").click(function(){
	...
	if(negotiator.negotiationType == 0){
		parent.layer.open({
	        ...
	        ,title: '添加谈判'
	        ,area: ['1100px','600px']
	        ,content:'Auction/Auction/Agent/PucharesSupplierNegotiator/addNegotiator.html?projectId='+projectId+'&id='+packageId
	        //,btn: ['提交','取消'] 
	        ,id:"addNegotiator"
	        //确定按钮
	       ,success:function(layero, index){
