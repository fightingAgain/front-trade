...
//							width: '200px',
							formatter:function(value,row){
								if(value){
									return '<span style="white-space: normal;width:200px">'+value+'</span>';
								}
							}
						},
						{
...
//							width: '200px',
				...
				recordOnce();
				//初始化tab
				var theight = $(document).height()- 200;
				column_left && $('.leftTab').bootstrapTable({
					height: theight,
					columns: column_left,
					data: packageData.details || packageData.packageDetails || packageData.offerlogs || recordOnceData.offerRounds,
					uniqueId: 'id',
