function textdata(isFile) {
	...
	for(var i = 0; i < packageData.length; i++) {
		...
		if(packageData[i].auctionType != 6 && packageData[i].auctionType != 7) {
			if(minData.length == 0) {
