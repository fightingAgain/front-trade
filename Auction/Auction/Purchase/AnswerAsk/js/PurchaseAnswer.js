...
window.operateEvents = { //添加一个按钮对应的事件
	...
	"click #btnShow": function(e, value, row, index) {
		layer.open({
			...
			resize: false, //是否允许拉伸
			/*content: 'Auction/Auction/Purchase/AnswerAsk/Answer.html',*/
			content: 'Auction/Auction/Purchase/AnswerAsk/Answer.html?projectId='+row.projectId+"&createType="+row.createType,
...
$("#checkState").change(function() {
	$('#PurchaseAnswer').bootstrapTable('refresh', {
		url: searchUrl
	});
