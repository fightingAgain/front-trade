...
//初始化
$(function() {
	// if(top.enterpriseNotice.isAuction==1){
	// 	$("#btn_add").show()
	// }else{
	// 	$("#btn_add").hide()
	// }
...
/// 表格初始化
var purchaseaddurl = 'Auction/Auction/Purchase/AuctionPurchase/model/againPurchaseAddModel.html' //重新竞价的添加的页面路径
var auditPurchase = 'Auction/Auction/Purchase/AuctionPurchase/model/auditPurchase.html' //查看路径
var editPurchase = 'Auction/Auction/Purchase/AuctionPurchase/model/AuctionInfo.html' //编辑路径
...
function queryParams(params) {
	return {
		...
		'enterpriseType': '04', //登陆人的身份。0为采购人，1为供应商
