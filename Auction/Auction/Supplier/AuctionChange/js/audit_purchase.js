...
function choseHistoryProject(){
	parent.layer.open({
	    ...
	    ,title: '历史变更记录'
	    ,area: ['1100px','600px']
	    ,content:'Auction/Auction/Supplier/AuctionChange/model/historyPurchasers.html?tenderType=1&projectId='+globalInfo.projectId
	    //,btn: ['关闭']
...
//						if(item == 'noticeEndDate'){
//							var projectSupplemen=data.data.projectSupplemen;
//							for(var n=0;n<projectSupplemen.length;n++){
//								if(data.data[noticeEndDate]==projectSupplemen[n].noticeEndDate){
//									$('#old'+item).html(projectSupplemen[n].noticeEndDate)
//								}
//							}
//						}
