...
var saveUrl = parent.config.bidhost+'/AskAnswersController/updateAskAnswers.do';//保存答复
...
var examType=getQueryString("examType");//资格审查的缓存
var inviteState= getQueryString("inviteState");//邀请函状态的缓存
var tenderType= getQueryString("tenderType");//项目类型的缓存
var examTypeCode= getQueryString("examTypeCode");//项目类型的缓存
var fileSize;//文件大小
var fileName;//文件名称
var filePath;//文件路径
var fileType;//文件类型
