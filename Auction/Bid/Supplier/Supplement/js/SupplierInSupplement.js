...
var viewpackage='Auction/common/Supplier/Supplement/model/invitChangeView.html';
var inviteStateCode;
var iframeWinAdd;
//表格初始化
$(function(){
...
function viewbao($index){
	...
	parent.layer.open({
		...
		resize: false
        ,content:viewpackage+'?supplier=1&examType='+rowData[$index].examType
        ,success:function(layero,index){          	
        	...
        	if(iframeWinAdd.projectSupplementList.length>0){ 
				var ind = iframeWinAdd.projectSupplementList.length - 1;
        		iframeWinAdd.SupplementInfo(iframeWinAdd.projectSupplementList[ind].id)        		
			} 
