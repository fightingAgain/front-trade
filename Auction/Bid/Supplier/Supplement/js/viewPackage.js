...
//查公告变更记录表
/* 
 isSupper: 是否供应商，供应商没有审核状态列
 */
function changeReacod(isSupper){
	...
	parent.layer.open({
        ...
        ,content:'Auction/common/Agent/Purchase/model/choicePackage.html?enterpriseType=06'
        ,success:function(layero,index){    
        	var iframeWind=layero.find('iframe')[0].contentWindow; 
        	iframeWind.changeTable(packageInfo.id,packageInfo.examType,callbacksupple, isSupper)
        }
    });
}
