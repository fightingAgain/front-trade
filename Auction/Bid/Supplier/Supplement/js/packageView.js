    ...
    var stHtml='<tr>'
            ...
            if(examType==0&&packageInfo.examCheckPlan==1){
                ...
                +'<td style="text-align: left;">'
                    +'<div id="keepNum"></div>'				
                +'</td>'
            }else if(examType==1&&(packageInfo.checkPlan==1||packageInfo.checkPlan==3)){
                stHtml+='<td style="width:200px;" class="th_bg">最大偏离数量</td>'
                +'<td style="text-align: left;">'
                    +'<div id="deviate"></div>'				
                +'</td>'
            }else{
            ...
            if((examType==0&&packageInfo.examCheckPlan==1)||(examType==1&&(packageInfo.checkPlan==1||packageInfo.checkPlan==3))){
                stHtml+='<tr>'
                stHtml+='<td style="width:200px;" class="th_bg">是否需要报名</td>'
                ...
                if(packageInfo.isSign==0&&packageInfo.isSellFile==1){
                    stHtml+='<td style="width:200px;" class="th_bg">是否发售'+ (examType==0? '资格预审文件':'采购文件') +'</td>'
                        +'<td style="text-align: left;">'
                ...
                if(packageInfo.isSign!=0||packageInfo.isSellFile!=1){
                    ...
                    stHtml+='<td style="width:200px;" class="th_bg">是否发售'+ (examType==0? '资格预审文件':'采购文件') +'</td>'
                        ...
                        if(packageInfo.isSellFile==0){
                            stHtml+='<td class="th_bg" style="width:200px;">'+ (examType==0? '资格预审文件费':'采购文件费') +'(元)</td>'
                                +'<td style="text-align: left;">'
                                    +'<div id="price"></div>'        			
                                +'</td> '
                        }  
