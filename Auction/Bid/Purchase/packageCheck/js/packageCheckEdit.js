...
var CheckUrl="Auction/common/Purchase/packageCheck/model/add_Check.html" //添加评价项页面
...
function site(){	
	...
	if(examType==1&&packageCheckListInfo.length>0){
 	...
 	parent.layer.open({
		...
		,title: '添加评审项'
		,area: ['550px', '500px']
		,content: 'Auction/common/Purchase/packageCheck/model/PackageCheckList.html?examType='+examType+'&checkPlan='+checkPlan+'&packageId='+packageInfo.id+'&sort='+(packageCheckListInfo.length+1)+'&isShowEnvelope='+doubleEnvelopes+'&isOpenDarkDoc='+isOpenDarkDoc       
	});
}
//修改评审项
function edit(){
	...
	parent.layer.open({
        ...
        ,title: '修改评审项'
        ,area: ['650px', '500px']
        ,content:'Auction/common/Purchase/packageCheck/model/PackageCheckList.html?examType='+examType+'&checkPlan='+checkPlan+'&id='+packageCheckListId+'&packageId='+packageInfo.id+'&index='+_$index+'&isShowEnvelope='+doubleEnvelopes+'&isOpenDarkDoc='+isOpenDarkDoc
	});          		          		        		 
};
//删除评审项
