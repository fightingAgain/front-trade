...
function view($index) {
	...
	parent.layer.open({
		...
		,
		content: 'Auction/common/Purchase/packageCheck/model/packageCheckLookPS.html?workflowType=' + WORKFLOWTYPE + '&purExamType=' + examTypenum + '&id=' + rowData[$index].id + '&packageId=' + packageInfo.id,
