...
function showData(i){
	parent.layer.open({
        ...
        ,title: '查看谈判记录详情'
        ,area: ['800px', '600px']
        ,content:'Auction/common/Purchase/PucharesSupplierNegotiator/showNegotiator.html'
...
$("#btnAdd").click(function(){
	...
	if(negotiator.negotiationType == 0){
		parent.layer.open({
	        ...
	        ,title: '添加谈判'
	        ,area: ['800px', '600px']
	        ,content:'Auction/common/Purchase/PucharesSupplierNegotiator/addNegotiator.html?projectId='+projectId+'&id='+packageId
	        //,btn: ['提交','取消'] 
	        ,id:"addNegotiator"
	        //确定按钮
	       ,success:function(layero, index){
