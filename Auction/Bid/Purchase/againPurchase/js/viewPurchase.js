		...
		success: function(data) {			
			...
			if(AccessoryList.length == 0) {
				...
				for(var i = 0; i < AccessoryList.length; i++) {
					...
					html += "<td><a href='javascript:void(0)' onclick='openAccessory(\"" + AccessoryList[i].fileName + "\",\"" + AccessoryList[i].filePath + "\")'>"+AccessoryList[i].fileName+"</a></td>";
					html += "</tr>";
				}
