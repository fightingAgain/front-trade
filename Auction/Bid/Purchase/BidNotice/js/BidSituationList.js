...
window.operateEvents = {
	...
	"click #checkDetail": function(e, value, row, index) {
		...
		top.layer.open({
			...
			resize: false, //是否允许拉伸
			closeBtn: 1,
			content: 'Auction/common/Purchase/BidNotice/modal/BidSituationInfo.html?examType='+examTypeCode+'&tenderType='+tenderTypeCode+'&projectId='+row.projectId+'&id='+row.packageId,
...
function getQueryParams(params) {
	var AuctionFile = {
		...
		/*isCheck: $("#isCheck").val(), //采购项目名称
		offerState: $("#offerState").val(), //采购醒目编号*/
