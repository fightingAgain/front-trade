...
function add_bao(){
	parent.layer.open({
        ...
        ,content:'Auction/common/Purchase/supplementNotice/model/choicePackage.html?tenderType=0&noticeType='+$("#noticeType").val()
...
function restlut(num){//num=0为临时保存1为提交
		...
		$.ajax({   	
		   	...
		   	async:false,
		   	//contentType:'application/json;charset=UTF-8',
		   	data:$("#formbackage").serialize()+'&supplementState='+num,
		   	success:function(data){			   		
