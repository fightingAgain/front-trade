...
$(function() {
	tenderTypeCode = 0;
	examTypeCode = 0;
	addpackage = 'Auction/common/Purchase/Purchase/model/purchaseChangeInfo.html';
	viewpackage = 'Auction/common/Purchase/Purchase/model/noticeChangeView.html';
	editpackage = 'Auction/common/Purchase/Purchase/model/purchaseChangeEdit.html'
	initTable();
...
function add_bao() {
	parent.layer.open({
		...
		title: '公告变更',
		area: ['1100px', '600px'],
		content: addpackage + '?tenderTypeCodes=' + tenderTypeCode,
		success: function(layero, index) {
			iframeWinAdd = layero.find('iframe')[0].contentWindow;
		}
	});
