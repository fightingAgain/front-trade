var addsupplier='Auction/common/Purchase/Purchase/model/add_supplier.html';//邀请供应商的弹出框路径
...
$("input[name='isPublics']").on('click',function(){
   if($(this).val()==0){
	   ...
	   $('.isPublics1').hide();
	   $(".yao_btn").hide();	
	   $("input[name='isSign'][value='1']").prop("checked",true);
	   priceTable()
   }else if($(this).val()==1){
	   ...
	   $(".yao_btn").show();
	   Public();
	   $("input[name='isSign'][value='0']").prop("checked",true);
	   priceTable()
   }
   $(".isPublics3").hide();
   $("#CODENAME").val("");
