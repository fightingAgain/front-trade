...
function btnSet(id,pk,isStopCheck,createType) {
	...
	if(msg == 1) {
		if(id != "") {
			var setUrl = "Auction/common/Agent/ReportCheckReady/ReportSet.html";
			if(examType == 1) {
				setUrl = "Auction/common/Agent/ReportCheck/ReportSet.html";
			}
			top.layer.open({
				type: 2,
				area: ['1100px', '600px'],
...
function toCheckInfo(id,pk,isSendMess,createType,isStopCheck) {
	...
	if(msg == 1) {
		if(id != "") {
			var infoUrl = "Auction/common/Agent/ReportCheckReady/ReportCheckInfo.html";
			if(examType == 1) {
				infoUrl = "Auction/common/Agent/ReportCheck/ReportCheckInfo.html";
			}
			//设置评审管理
			layer.open({
				type: 2, //此处以iframe举例
...
function winMiddel(projectId,packageId,createType){
	var checkUrl = "Auction/common/Agent/ReportCheckReady/PackageInfo.html";
	if(examType == 1) {
		checkUrl = "Auction/common/Agent/ReportCheck/PackageInfo.html";
	}
	top.layer.open({
		type: 2,
		area: ['100%', '100%'],
