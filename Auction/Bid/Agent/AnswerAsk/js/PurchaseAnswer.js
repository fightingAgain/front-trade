...
window.operateEvents = { //添加一个按钮对应的事件
	...
	"click #btnShow": function(e, value, row, index) {
		...
		layer.open({
			...
			title: '查看澄清',
			area: ["1100px", "600px"],			
			content: 'Auction/common/Agent/AnswerAsk/Answer.html?examType=' + examTypeCode +"&projectId="+row.projectId+"&id="+row.packageId+"&createType="+row.createType,
