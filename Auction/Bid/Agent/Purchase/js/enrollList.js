...
var addpackage = 'Auction/common/Agent/Purchase/model/noticeInfo.html'; //添加包件弹出框路径
var viewpackage = 'Auction/common/Agent/Purchase/model/enrollInfo.html'
var iframeWinAdd = "";
	...
	$('#table').bootstrapTable({
		...
		columns: [{
			...
			formatter: function(value, row, index) {
				...
				var Tdr = '<a class="btn-sm btn-primary" href="javascript:void(0)" style="text-decoration:none" onclick=viewbao(\"' + index + '\")><span class="glyphicon glyphicon-search" aria-hidden="true"></span>查看</a>'
