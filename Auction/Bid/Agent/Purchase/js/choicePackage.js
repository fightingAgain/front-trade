...
function initTable(type,callback) {
	...
	// 搜索按钮触发事件
	$("#eventquery").off('click').click(function() {	    
...
function queryParams(params) {
	    var para={		 
		    ...
		    'enterpriseType':(enterpriseType||'02'),
		    'checkType':1,
//		    'examType':0,
//		    'packageState':4,
...
function changeTable(uid,examType,callbacksupple, isSupper){
	$("#toolbar").hide()
	var reluse=[];
	$.ajax({
		url: findPageList,
		...
		data: {
			...
			"tenderType": 0,
			'examType':examType,
			"enterpriseType":enterpriseType||'02' //04采购人 02代理机构 06供应商
		},
