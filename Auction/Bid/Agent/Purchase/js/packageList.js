...
var eidteditpackage='Auction/common/Agent/Purchase/model/eidtPackageInfo.html';
var addpackage='Auction/common/Agent/Purchase/model/addPackageInfo.html';
...
function edit_bao($index){	
	...
	parent.layer.open({
        ...
        ,success:function(layero,index){    
        	var iframeWind=layero.find('iframe')[0].contentWindow;
        	iframeWind.projectType=rowData[$index].projectType;
        	iframeWind.$("#examType").val(examType)
