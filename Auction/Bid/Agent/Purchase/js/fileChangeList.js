	...
	$('#table').bootstrapTable({
		...
		columns: [{
			...
			formatter:function(value, row, index){
				...
				var Tdr='<a class="btn-sm btn-primary" href="javascript:void(0)" style="text-decoration:none" onclick=fileView(\"'+ index +'\")><span class="glyphicon glyphicon-search" aria-hidden="true"></span>查看</a>';
	     		return Tdr;
...
function fileView($index){
	...
	parent.layer.open({
        ...
        ,content:'Auction/common/Agent/Purchase/model/fileChangeInfo.html?projectId='+rowData[$index].projectId+'&packageId='+rowData[$index].packageId+'&examType=' + examTypeCode + '&keyId='+rowData[$index].id
