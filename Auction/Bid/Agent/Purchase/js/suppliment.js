...
function suppliment(){
	...
	if(projectSupplementList.length==0){	
		List='<tr>'
     		+'<td class="th_bg">'+(examType==0?'资格预审':'')+'公告开始时间</td>'
     		+'<td style="text-align: left;width:320px">'
     			+'<div id="noticeStartDate"></div>'    			
     		+'</td>'
     		+'<td class="th_bg">'+(examType==0?'资格预审':'')+'公告截止时间</td>'
     		+'<td style="text-align: left;width:320px">'
     	...
     	if(packageInfo.isSign==1){	       
     		List+='<tr>'
     				List+='<td class="th_bg" >报名开始时间</td>'
					+'<td  style="text-align: left;">'
						+'<div id="signStartDate"></div>'				
					+'</td>'
					List+='<td class="th_bg" >报名截止时间</td>'
					+'<td  style="text-align: left;">'
     	...
     	List+='<tr>'
     		+'<td  class="th_bg">'+(examType==0?'资格预审':'')+'提出澄清截止时间</td>'
     		+'<td style="text-align: left;">'
     			+'<div id="'+(examType==0?'examAskEndDate':'askEndDate')+'"></div>'     			
     		+'</td >'
     		+'<td  class="th_bg">'+(examType==0?'资格预审':'')+'答复截止时间</td>'
     		+'<td style="text-align: left;">'
     	...
     	List+='<tr>'	     		
	     		if(examType==0){     			      
	 			List+='<td  class="th_bg">资格预审申请文件递交截止时间</td>'
	     		+'<td class="newTime" style="text-align: left;">'
	     			+'<div id="submitExamFileEndDate"></div> '    			
	     		+'</td>'
	     		}else{
	     			List+='<td  class="th_bg"><span>报价截止时间</span></td>'
		     		+'<td  style="text-align: left;">'
		     			+'<div  id="offerEndDate"></div>'
		     		+'</td>'
	     		}
	     	   List+='<td  class="th_bg">'+(examType==0?'资格预审时间': reviewStartTimeLabel)+'</td>'
	     		+'<td style="text-align: left;">'
...
function supplimentInt(examTypeShows){
	...
	if(projectSupplementList.length==0){
			if(examTypeShow==1){
				List='<tr>'
		     		+'<td  class="th_bg">接受邀请开始时间</td>'
		     		+'<td style="text-align: left;width:320px">'
		     			+'<div id="noticeStartDate"></div>'    			
		     		+'</td>'
		     		+'<td  class="th_bg">接受邀请截止时间</td>'
		     		+'<td style="text-align: left;width:320px">'
		     			+'<div id="noticeEndDate"></div> '   			
		     		+'</td>'
		     	+'</tr>'
			...
			if(packageInfo.isSign==1&&examTypeShow==1){
			 	List+='<tr>'
     			+'<td class="th_bg" >报名开始时间</td>'
					+'<td   style="text-align: left;">'
						+'<div id="signStartDate"></div>'				
					+'</td>'
					+'<td class="th_bg" >报名截止时间</td>'
					+'<td  style="text-align: left;">'
						+'<div id="signEndDate"></div>'				
					+'</td>'
				+'</tr>' 
	     	...
	     	List+='<tr>'
	     		+'<td  class="th_bg">提出澄清截止时间</td>'
	     		+'<td style="text-align: left;">'
	     			+'<div id="askEndDate"></div>'     			
	     		+'</td >'
	     		+'<td  class="th_bg">答复截止时间</td>'
	     		+'<td style="text-align: left;">'
	     	...
	     	if(examTypeShow==0){
	     		List+='<tr>'
			 		...
			 		+'</td>'
					+'<td  class="th_bg">报价截止时间</td>'
			 		+'<td style="text-align: left;">'
			 			+'<div id="offerEndDate"></div> '    			
			 		+'</td>'
			   	+'</tr>'
			   	+'<tr>'
			   		+'<td  class="th_bg">' + reviewStartTimeLabel + '</td>'
	...
	var List="";
		List+='<tr>'
     	...
     	List+='<tr>'
     		...
     		+'<td style="text-align: left;width:320px">'
     			+'<div id="noticeEndDate"></div>'     			
     		+'</td >'    		
     		+'<td  class="th_bg">原始'+(examType==0?'资格预审':'')+'公告截止时间</td>'
     		+'<td style="text-align: left;width:320px">'
     			+'<div id="oldNoticeEndDate"></div>'     			
     		+'</td >'
     	+'</tr>'
		...
		List+='<tr>'
     		...
     		+'<td style="text-align: left;">'
     			+'<div id="'+(examType==0?'examAskEndDate':'askEndDate')+'"></div>'     			
     		+'</td >'
     		+'<td  class="th_bg">'+(examType==0?'原始资格预审':'原始')+'提出澄清截止时间</td>'
     		+'<td style="text-align: left;">'
     			+'<div id="'+(examType==0?'oldExamAskEndDate':'oldAskEndDate')+'"></div>'     			
     		+'</td >'
     	+'</tr>' 
     	List+='<tr>'
     		...
     		+'<td style="text-align: left;">'
     			+'<div id="'+(examType==0?'examAnswersEndDate':'answersEndDate')+'"></div>'     			
     		+'</td >'
     		+'<td  class="th_bg">'+(examType==0?'原始资格预审':'原始')+'答复截止时间</td>'
     		+'<td style="text-align: left;">'
     			+'<div id="'+(examType==0?'oldExamAnswersEndDate':'oldAnswersEndDate')+'"></div>'     			
     		+'</td >'
     	+'</tr>'
     	...
     	List+='<tr>'
     		...
     		+'<td style="text-align: left;">'
     			+'<div id="checkEndDate"></div>'     			
     		+'</td >'
     		+'<td  class="th_bg">原始' + reviewStartTimeLabel + '</td>'
     		+'<td style="text-align: left;">'
     			+'<div id="oldCheckEndDate"></div>'	
     		+'</td>'
     	+'</tr>'
     	...
     	if(examType==0){
     	List+='<tr>'
     		+'<td  class="th_bg">资格预审申请文件递交截止时间</td>'
     		+'<td style="text-align: left;">'
     			+'<div id="submitExamFileEndDate"></div>'	
     		+'</td>'
     		+'<td  class="th_bg">原始资格预审申请文件递交截止时间</td>'
     		+'<td style="text-align: left;">'
     			+'<div id="oldSubmitExamFileEndDate"></div>'	
     		+'</td>'
     	+'</tr>'
     	List+='<tr>'
     		+'<td  class="th_bg">资格预审时间</td>'
     		+'<td style="text-align: left;">'
     			+'<div id="examCheckEndDate"></div>'	
     		+'</td>'
     		+'<td  class="th_bg">原始资格预审时间</td>'
     		+'<td style="text-align: left;">'
