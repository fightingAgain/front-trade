...
var searchUrl = parent.config.bidhost + "/NegotiationController/pagePurNegotiation.do"; //成员查询接口
var saveUrl = parent.config.bidhost + "/NegotiationController/saveAllNegotiationEmployee.do";//保存接口
var sUrl = parent.config.bidhost +"/NegotiationController/findPageList.do";//谈判员查询接口
	...
	columns: [
		[{
				...
				formatter: function(value, row, index) {
					...
					if(negotiationLists != null && negotiationLists != "" ) {
