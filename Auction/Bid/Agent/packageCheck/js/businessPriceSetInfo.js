...
function scoreTypeBtnl(_c){
	...
	if(_c==3){
		Assessment+='<tr>'	
						...
						+'<td class="th_bg">权重值（0~1）<i class="red">*</i></td>'
						+'<td><input class="form-control" type="text" name="weight"  id="weight" readonly="readonly" style="width:200px" /></td>'						
						+'<td style="text-align: left;" colspan="2">商务报价分值=100</td>'
					+'</tr>'
					+'<tr>'
						+'<td colspan="5" style="text-align: left;"><strong>最低报价为基准价评分</strong></td>'						
					+'</tr>'
					+'<tr>'
	...
	if(_c==0){
		...
		ue.ready(function() {
			...
			if (businessPriceSetData) {
				content = businessPriceSetData.businessContent||"";
			}
