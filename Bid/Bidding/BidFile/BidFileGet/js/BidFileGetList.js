...
var urlSearchList = config.tenderHost+'/DocClarifyController/findTenderDocClarifyPageList.do';//招标文件--标段查询分页接口
...
function checkMessage(){
	$.ajax({
		...
		async: false,
		data:{
			packageId:bidData.bidSectionId,
         			...
         			if(getData.canDownload == 1){
			    		...
			    		layer.open({
							...
							success:function(layero, index){
								...
								iframeWin.passMessage(bidData, isGather);
							}
						});
         			}else{
