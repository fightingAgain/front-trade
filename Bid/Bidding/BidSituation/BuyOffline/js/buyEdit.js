...
var bidSectionPage = 'Bidding/BidSituation/BuyOffline/model/bidSectionList.html';  //标段列表
var pageEdit = 'Bidding/BidSituation/BuyOffline/model/supplierEdit.html';  //编辑投标人购标信息
var pageView = 'Bidding/BidSituation/BuyOffline/model/supplierView.html';  //编辑投标人购标信息

var listUrl = config.tenderHost + '/SupplierSignController/selectByBidSectionId.do';  //线下购标的供应商列表
...
function passMessage(data){
	if(data){
		...
		if(data.tenderMode == 2 || data.examType == 1){//邀请
			$("#addBtn").hide();
		} else {
			$("#addBtn").show();
		}
