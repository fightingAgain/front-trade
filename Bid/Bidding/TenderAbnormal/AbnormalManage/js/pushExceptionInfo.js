var pushUrl = config.tenderHost + '/projectReceptionController/sendProjectExcepiton.do';//推送接口
var getInfoUrl = config.tenderHost + '/projectReceptionController/findProjectExcepiton.do';//获取推送数据详情接口
