var listUrl = config.tenderHost + '/ControlPriceController/pageCheckerList.do';  //列表接口
...
$(function(){
	...
	//审核
	$("#tabList").on("click", ".btnApproval", function(){
...
//	console.log("^^^^"+JSON.stringify(rowData));
	layer.open({
		...
		area: [width + 'px', height + 'px'],
		resize: false,
		content: pageView + "?id=" + rowData[index].controlPriceId + "&source=" + source,
		success:function(layero, index){
