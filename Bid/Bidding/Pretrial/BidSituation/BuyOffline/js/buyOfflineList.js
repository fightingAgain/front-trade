...
var pageUrl = config.tenderHost + '/SupplierSignController/findPageList.do';  //列表接口


var viewHtml = 'Bidding/BidSituation/BuyOffline/model/buyView.html';//查看
var pageEdit = 'Bidding/BidSituation/BuyOffline/model/buyEdit.html';  //编辑
