	...
	$.ajax({
		...
		success: function(data){
			if(data.success){
				...
				if(dataSource){
					if(dataSource.pretrialCheckType ){//预审评审办法 1.合格制 2.有限数量制  3.评审制
						if(dataSource.pretrialCheckType == 1){
							$("#checkType").html("合格制");
						}else if(dataSource.pretrialCheckType == 2){
							$("#checkType").html("有限数量制");
						}else if(dataSource.pretrialCheckType == 3){
							$("#checkType").html("评审制");
						}
					}
