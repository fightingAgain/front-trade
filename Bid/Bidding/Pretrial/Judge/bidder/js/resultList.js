...
*  方法列表及功能描述
*/
var listUrl = config.tenderHost + '/BidWinNoticeController/findGYSYuShenPageList.do';  //列表接口
var viewHtml = 'Bidding/Pretrial/Judge/bidder/model/resultView.html';//查看
...
function openView(index){
	...
	layer.open({
		...
		title: '查看预审结果公示',
		area: ['80%', '80%'],
		content: viewHtml+'?id='+rowData.id+'&bidId='+rowData.bidSectionId + "&isThrough=" + (rowData.noticeState == 2 ? 1 : 0)+'&pretrialCheckType='+rowData.pretrialCheckType,
		resize: false,
