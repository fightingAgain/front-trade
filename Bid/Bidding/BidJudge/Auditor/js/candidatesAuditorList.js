...
*  方法列表及功能描述
*/
var auditHtml = "Bidding/BidJudge/Auditor/model/candidatesAudit.html"; // 审核
var pageUrl = config.tenderHost  + "/BidSuccessFulPublicityController/pageCheckList.do"; 	//分页
//入口函数 
$(function(){
	//加载列表
	initJudgeTable();
