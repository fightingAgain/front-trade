...
*  方法列表及功能描述
*/
var listUrl = config.tenderHost + '/BidWinNoticeServerController/findBidWinNoticePageList.do';  //列表接口
		...
		columns: [
			[{
				...
				},
				{
					...
					formatter: function(value, row, index){
						if(value == 1){//公示性质  1 正常公告 2 更正公告 3 重发公告 9 其他
							return  '<span>正常公示</span>'
						}else if(value == 2){
							return  '<span>更正公示</span>'
						}
					}
				},
				{
