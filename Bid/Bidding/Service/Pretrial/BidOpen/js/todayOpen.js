...
//						if(row.invitePurchase || row.inviteSupervise){
							handler = "<a class='btn btn-primary btn-sm' href='OpenTender/fileOpen/manager/model/pretrialRoomVG.html?bid="+row.bidSectionId+"' target='开标大厅' ><span class='glyphicon glyphicon-eye-open'></span>查看</a>";
//						}
						return handler;
					}
				}
