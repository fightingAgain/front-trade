...
var pageUrl = config.tenderHost + '/SupplierSignBiddingController/findPitchPageList.do';  //列表接口

var viewHtml = 'Bidding/Pretrial/BidSituation/TenderSituation/model/tenderView.html';//查看
//入口函数 
$(function(){
	//加载列表
	initJudgeTable();
