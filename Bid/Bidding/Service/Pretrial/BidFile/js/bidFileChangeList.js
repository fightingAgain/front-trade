...
var urlBidFileList = config.tenderHost + '/PretrialDocClarifyServerController/findPretrialChangDocPageList.do'; //资格预审文件--标段查询分页接口
...
function openView(index) {
	...
	layer.open({
		...
		resize: false,
		content: pageView + "?source=0" + "&id=" + rowData.id + "&isThrough=" + (rowData.pretrialDocClarifyState == 2 ? 1 : 0), //标段主键id
