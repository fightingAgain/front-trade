...
var listUrl = config.tenderHost + '/AnswerMeetingNoticeController/findChooseSummaryPageList.do';  //列表接口
//var listUrl = config.tenderHost + '/ReconnaissanceSiteController/findChoosePublicSummaryPageList..do';  //列表接口    进场
