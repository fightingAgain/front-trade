...
*  方法列表及功能描述
*/
var listUrl = config.tenderHost + '/AnswerMeetingNoticeController/findPageList.do';  //列表接口

var bidHtml = 'Bidding/Clarify/answerMeeting/meetingNotice/model/bidList.html';//标段列表
var editHtml = 'Bidding/Clarify/answerMeeting/meetingNotice/model/noticeEdit.html';//编辑页面
var viewHtml = 'Bidding/Clarify/answerMeeting/meetingNotice/model/noticeView.html';//查看
...
function openView(data){
	layer.open({
		...
		title: '查看答疑会通知',
		area: ['100%', '100%'],
		content: viewHtml+'?id='+data.bidSectionId,
		resize: false,
		success:function(layero, index){
			var iframeWin = layero.find('iframe')[0].contentWindow;
			//调用子窗口方法，传参
