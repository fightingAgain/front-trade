...
*  方法列表及功能描述
*/
var listUrl = config.tenderHost + '/ReconnaissanceSiteController/findPageList.do';  //列表接口

var bidHtml = 'Bidding/Scouting/scoutingNotice/model/bidList.html';//标段列表
var editHtml = 'Bidding/Scouting/scoutingNotice/model/noticeEdit.html';//编辑页面
var viewHtml = 'Bidding/Scouting/scoutingNotice/model/noticeView.html';//查看
