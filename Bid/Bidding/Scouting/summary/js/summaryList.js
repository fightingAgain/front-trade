...
*  方法列表及功能描述
*/
var listUrl = config.tenderHost + '/ReconnaissanceSiteController/findSummaryPageList.do';  //列表接口

var bidHtml = 'Bidding/Scouting/summary/model/bidList.html';//标段列表
var editHtml = 'Bidding/Scouting/summary/model/summaryEdit.html';//编辑页面
var viewHtml = 'Bidding/Scouting/summary/model/summaryView.html';//查看
