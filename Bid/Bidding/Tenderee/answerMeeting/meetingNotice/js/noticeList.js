...
*  方法列表及功能描述
*/
var listUrl = config.tenderHost + '/AnswerMeetingNoticeController/findTenderPageList.do';  //列表接口

var viewHtml = 'Bidding/Tenderee/answerMeeting/meetingNotice/model/noticeView.html';//查看
