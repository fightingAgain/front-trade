...
*  方法列表及功能描述
*/
var listUrl = config.tenderHost + '/AnswerMeetingNoticeController/findTenderSummaryPageList.do';  //列表接口

var viewHtml = 'Bidding/Tenderee/answerMeeting/summary/model/summaryView.html';//查看
