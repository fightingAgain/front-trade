...
*  方法列表及功能描述
*/
var listUrl = config.tenderHost + '/ReconnaissanceSiteController/findTenderPageList.do';  //列表接口

var viewHtml = 'Bidding/Tenderee/scoutingNotice/model/noticeView.html';//查看
