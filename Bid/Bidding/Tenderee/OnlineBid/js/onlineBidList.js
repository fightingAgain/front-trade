var listUrl = config.tenderHost + '/BidFileController/bidFilePageList.do';  //列表接口
var revokeUrl = config.tenderHost + '/BidFileController/delete.do';  //撤回接口
...
var pageEdit = "Bidding/Tenderee/OnlineBid/model/fileEdit.html";  //编辑页面
var bidSectionPage = 'Bidding/Tenderee/OnlineBid/model/bidSectionList.html';  //标段列表
var CAcf = null;  //实例化CA
var reason = "";
...
function openView(index){
	...
	layer.open({
		...
		title: "查看监标人",
		area: [width + 'px', height + 'px'],
		content: viewPage + "?id=" + rowData.bidFileId + "&source=0",
